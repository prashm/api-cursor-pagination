...
### Features
- `validate_and_set_pagination_options` method for page request parameter validation
- `paginated_rows` method for retrieving paginated results
- `paginated_meta` method for generating pagination metadata
