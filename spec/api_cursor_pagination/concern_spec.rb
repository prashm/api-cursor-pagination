...
RSpec.describe ApiCursorPagination::Concern do
  ...
  describe "#validate_and_set_pagination_options" do
    context "when no page options are provided" do
      it "sets page_size to 0" do
        instance.validate_and_set_pagination_options({})
    ...
    context "when valid page size is provided" do
      ...
      it "sets the page_size correctly" do
        instance.validate_and_set_pagination_options(params[:page])
  ...
  describe "#paginated_rows" do
    ...
    context "when page_size is 0" do
      ...
      it "returns all records without pagination" do
        result = instance.paginated_rows(scope, "id")
    ...
    context "when page_size is greater than 0" do
      ...
      it "sets total_size correctly" do
        instance.paginated_rows(scope, "id")
  ...
  describe "#paginated_meta" do
    ...
    context "when page_size is 0" do
      ...
      it "returns empty hash" do
        result = instance.paginated_meta(base_url, query_params)
        expect(result).to eq({})
      end
    end
